...
Public Class CrystalReportDosenNIPTertentu
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportDosenNIPTertentu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project_Akademik_Irpan.CrystalReportDosenNIPTertentu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nip() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReportDosenNIPTertentu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportDosenNIPTertentu = New CrystalReportDosenNIPTertentu()
        rpt.Site = Me.Site
        Return rpt
    End Function
